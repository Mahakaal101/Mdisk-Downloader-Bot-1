...
# app
bot_token = os.environ.get("TOKEN", "5480557136:AAHpjdkEVJ15tMvBkpgy2k3AQcdhV5qD80Y") 
...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Contact @Aaajaats To Use this bot**__',reply_to_message_id=message.id,reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("📦 Update Channel", url="https://t.me/anumitultrabots")]]))
        return
...
def help(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Contact @Aaajaats To Use this bot**__',reply_to_message_id=message.id)
        return
