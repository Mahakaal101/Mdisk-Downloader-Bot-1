...
# app
bot_token = os.environ.get("TOKEN", "5537730626:AAGOu_5Rg0xlzFyi5M1tSkvWcPxGkhw8o60") 
...
# optionals
auth = os.environ.get("AUTH", "1864861524,5076949930,1845343032,5215205205,1787835645,306027849,683684279,1406840926,597718002,1843393081,5316294458,1252277288,716395388,721234444,5546272226,796124761,1065887386,1056446957,5135693898,626860526,1036492864,1196926662,1978420804,5740882350,5290630238")
...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Contact @Aaajats To Use this bot**__',reply_to_message_id=message.id,reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("📦 Update Channel", url="https://t.me/anumitultrabots")]]))
        return
...
def help(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Contact @Aaajats To Use this bot**__',reply_to_message_id=message.id)
        return
