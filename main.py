...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, 'You Don't buy Subscription For Plans Details Please Contact To @Aaajaats__',reply_to_message_id=message.id,reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("📦 Update Channel", url="t.me/anumitultrabots")]]))
        return
